...
// Fix Type for schoolNavMap
if (!sd.includes('PortalViewer')) {
    sd = sd.replace(/SchoolExperienceRole,/, 'SchoolExperienceRole, PortalViewer,');
}

// Fix Library / Activity import
if (!sd.includes('Library,')) {
    sd = sd.replace(/LayoutGrid,/, 'LayoutGrid,\n  Library,\n  Activity,');
}

// Generate code for schoolNavMap
