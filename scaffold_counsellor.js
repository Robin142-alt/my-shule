...
const workspaces = [
  { id: "overview", label: "Overview", icon: "LayoutDashboard", group: "Command", desc: "Counsellor's daily command centre." },
  { id: "referrals", label: "Referral Inbox", icon: "Inbox", group: "Intake", desc: "Process referrals from other staff." },
  { id: "cases", label: "Student Cases", icon: "UsersRound", group: "Caseload", desc: "Main case management for learners." },
  { id: "appointments", label: "Appointments", icon: "CalendarClock", group: "Caseload", desc: "Counselling sessions and walk-ins." },
  { id: "sessions", label: "Session Notes", icon: "FileLock2", group: "Caseload", desc: "Confidential session recording." },
  { id: "followups", label: "Follow-ups", icon: "ListTodo", group: "Welfare", desc: "Ongoing learner support tracking." },
  { id: "welfare", label: "Welfare Concerns", icon: "HeartPulse", group: "Welfare", desc: "Broader learner welfare issues." },
  { id: "group", label: "Group Guidance", icon: "Users", group: "Welfare", desc: "Life skills and group sessions." },
  { id: "parents", label: "Parent Engagement", icon: "Handshake", group: "Collaboration", desc: "Parent/guardian communication." },
  { id: "teachers", label: "Teacher Collaboration", icon: "Briefcase", group: "Collaboration", desc: "Work with staff safely." },
  { id: "discipline", label: "Discipline Referrals", icon: "ShieldAlert", group: "Collaboration", desc: "Behaviour intervention cases." },
  { id: "health", label: "Health Referrals", icon: "Stethoscope", group: "Collaboration", desc: "Medical/Nurse referrals." },
  { id: "escalations", label: "Safeguarding / Escalations", icon: "Siren", group: "Critical", desc: "Urgent/serious welfare concerns." },
  { id: "reports", label: "Reports", icon: "FileBarChart2", group: "Resources", desc: "Safe, limited analytics." },
  { id: "templates", label: "Resources & Templates", icon: "FolderOpen", group: "Resources", desc: "Forms and guidance materials." },
  { id: "settings", label: "Settings", icon: "Settings", group: "System", desc: "Counsellor preferences." }
];

const tsx = `// GENERATED COUNSELLOR COMMAND CENTER
"use client";
...
type CounsellorView = ${workspaces.map(w => `"${w.id}"`).join(" | ")};
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-[#64748B]">MyShule • Term 2, 2026</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="grid h-10 w-10 place-items-center rounded-full border border-slate-200 hover:bg-slate-50 relative">
...
fs.writeFileSync(path.join(__dirname, 'apps/web/src/components/school/counsellor-command-center.tsx'), tsx);
console.log("Counsellor Dashboard scaffolded successfully.");
