...
const tsx = `// GENERATED BY scaffold_security.js
"use client";
    ...
    <Panel title="Gate Command Center" description="Live summary of what is happening today." icon={LayoutDashboard} actions={
      ...
      <div className="grid gap-4 md:grid-cols-4 lg:grid-cols-4 mb-6">
        <div className="rounded-xl border border-[#D8E0EC] bg-[#F8FAFC] p-4 cursor-pointer hover:border-blue-300 transition" onClick={() => onNavigate("visitor-register")}>
          ...
          <div className="mt-1 text-2xl font-black text-emerald-600">12</div>
        </div>
            ...
            <div className="p-4 overflow-x-auto">
              <table className="w-full text-sm text-left whitespace-nowrap">
                ...
                <tbody className="divide-y divide-[#D8E0EC]">
                  <tr>
                    <td className="py-3 text-[#64748B]">08:15 AM</td>
                    <td className="py-3 font-medium text-[#071D49]">Jane Doe</td>
                    <td className="py-3 text-[#64748B]">Parent</td>
                    <td className="py-3 text-[#64748B]">Meeting Principal</td>
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-[#D8E0EC] p-4 bg-[#F8FAFC]">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <input type="text" placeholder="Full Name" className="rounded-lg border border-[#D8E0EC] p-2 text-sm" />
              <input type="text" placeholder="Phone Number" className="rounded-lg border border-[#D8E0EC] p-2 text-sm" />
              <input type="text" placeholder="Purpose of Visit" className="rounded-lg border border-[#D8E0EC] p-2 text-sm sm:col-span-2" />
              <input type="text" placeholder="Person/Office to see" className="rounded-lg border border-[#D8E0EC] p-2 text-sm sm:col-span-2" />
              <div className="flex gap-2 sm:col-span-2 pt-2">
                <button className="flex-1 rounded-lg bg-[#071D49] py-2 text-sm font-black text-white">Check In & Print Pass</button>
            ...
            <table className="w-full text-sm text-left whitespace-nowrap">
              ...
              <tbody className="divide-y divide-[#D8E0EC]">
                <tr className="hover:bg-[#F8FAFC]">
                  <td className="px-4 py-3 text-[#64748B]">08:10 AM</td>
                  <td className="px-4 py-3 font-semibold text-[#071D49]">John Smith</td>
        ...
        <table className="w-full text-sm text-left whitespace-nowrap">
          ...
          <tbody className="divide-y divide-[#D8E0EC]">
            <tr className="hover:bg-[#F8FAFC]">
              ...
              <td className="px-4 py-3 font-semibold text-[#071D49]">John Smith</td>
              <td className="px-4 py-3 text-[#64748B]">Deliveries</td>
...
fs.writeFileSync('apps/web/src/components/school/security-command-center.tsx', tsx);
console.log('Successfully generated apps/web/src/components/school/security-command-center.tsx');
