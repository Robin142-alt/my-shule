...
const tsx = `// GENERATED BY scaffold_system_monitor.js
"use client";
...
fs.mkdirSync(path.dirname('apps/web/src/components/platform/system-monitor-dashboard.tsx'), { recursive: true });
fs.writeFileSync('apps/web/src/components/platform/system-monitor-dashboard.tsx', tsx);
console.log('Successfully generated apps/web/src/components/platform/system-monitor-dashboard.tsx');
