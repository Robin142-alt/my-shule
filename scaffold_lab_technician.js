...
const tsx = `// GENERATED BY scaffold_lab_technician.js
"use client";
...
fs.writeFileSync('apps/web/src/components/school/laboratory-technician-command-center.tsx', tsx);
console.log('Successfully replaced apps/web/src/components/school/laboratory-technician-command-center.tsx');
