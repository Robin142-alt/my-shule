...
const workspaces = [
  { id: "overview", label: "Overview", icon: "LayoutDashboard", group: "Command", desc: "Grade/Form Master daily command center." },
  { id: "learners", label: "Learners", icon: "Users", group: "Grade Operations", desc: "Manages and monitors all learners in the assigned grade/form." },
  { id: "streams", label: "Streams & Class Teachers", icon: "Network", group: "Grade Operations", desc: "Coordinate all class teachers and streams under the form/grade." },
  { id: "attendance", label: "Attendance Monitor", icon: "UserCheck", group: "Grade Operations", desc: "Monitor completion and follow up on absenteeism across streams." },
  { id: "academics", label: "Academic Progress", icon: "TrendingUp", group: "Academics", desc: "Monitor academic performance trends across the entire form/grade." },
  ...
  { id: "assignments", label: "Assignments & Homework", icon: "BookOpenCheck", group: "Planning", desc: "Monitors whether learners in the grade/form are receiving and submitting work." },
  { id: "requests", label: "Requests & Approvals", icon: "CheckSquare", group: "Resources", desc: "Handles requests that the Grade/Form Master can raise or review." },
  { id: "reports", label: "Reports & Downloads", icon: "FileText", group: "Resources", desc: "Printable and exportable grade/form reports." },
  { id: "notifications", label: "Notifications", icon: "Bell", group: "System", desc: "Notification inbox for tasks and alerts related to the assigned form/grade." },
  { id: "teaching", label: "My Teaching Workspace", icon: "BookMarked", group: "System", desc: "Teaching responsibilities for assigned subjects." },
  { id: "settings", label: "Settings", icon: "Settings", group: "System", desc: "Dashboard preferences and limited form/grade workflow settings." },
];

const tsx = `// GENERATED BY scaffold_grade_master.js
"use client";
...
type GradeView = ${workspaces.map(w => `"${w.id}"`).join(" | ")};
    ...
    <div className="flex min-h-screen bg-[#F3F6FA]">
      ...
      <aside className="hidden h-screen w-[260px] overflow-y-auto bg-[#071D49] p-4 text-white shadow-[0_24px_70px_rgba(7,29,73,0.28)] lg:block shrink-0">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-4 mb-6">
          ...
          <p className="mt-2 text-sm leading-6 text-white/65">Form 2 — All Streams oversight.</p>
        </div>
          ...
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-[#64748B]">Form 2 Master • Term 2, 2026 • Current Week: Week 5</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
               ...
               <button className="inline-flex h-10 items-center justify-center rounded-xl bg-[#071D49] px-4 text-sm font-black text-white">Take Quick Action</button>
            </div>
          </div>
          {/* Mobile Nav Selector */}
...
fs.writeFileSync('apps/web/src/components/school/grade-master-command-center.tsx', tsx);
console.log('Successfully regenerated apps/web/src/components/school/grade-master-command-center.tsx with the 18 specific workspaces.');
