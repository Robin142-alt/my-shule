...
Generated at: 2026-05-20T23:17:06.193Z
...
| admissions-application-search | Admissions application search should use the admissions full-text index. | Limit, Sort, Index Scan | clear |
| inventory-item-search | Inventory item search should use the inventory item full-text index. | Limit, Sort, Index Scan | clear |
...
| exam-marks-student-series | Exam mark lookup should use the student/report-card indexes. | Limit, Sort, Index Scan | clear |
...
| hr-staff-profile-directory | Hidden HR staff directory read path remains tenant scoped. | Limit, Sort, Index Scan | clear |
...
| support-ticket-search | Support ticket search should use the support ticket full-text index. | Limit, Sort, Index Scan | clear |
| discipline-incident-queue | Discipline incident queue should use tenant/status/severity indexes. | Limit, Incremental Sort, Index Scan | clear |
