...
Generated at: 2026-07-27T09:10:17.792Z
...
| --- | --- | --- | --- |
| IMPLEMENTATION101-001-iot | IoT and Smart Campus | pass | pass: IoT has a live workspace; pass: IoT has a live frontend API proxy; pass: IoT has a backend controller; pass: IoT has persistent schema evidence; pass: IoT has workflow and schema tests |
