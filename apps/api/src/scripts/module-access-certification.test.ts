...
const passingSources: Record<string, string> = {
  ...
  'apps/web/src/lib/module-access/module-access-map.ts': 'schoolSectionModuleMap students: "students" admissions: "admissions" finance: "finance" mpesa: "finance" academics: "academics" exams: "exams" discipline: "discipline" reports: "reports" communication: "communication_sms" timetable: "timetable" staff: "staff" inventory: "inventory" library: "library" clinic: "clinic_health" labs: "lab_management" "teacher-attendance": "teacher_biometric_attendance" leadership: "admin_command_centers" isSchoolSectionEnabled filterNavItemsByEnabledModules',
