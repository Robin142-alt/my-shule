...
const MODULE_EVIDENCE_INPUTS: ModuleEvidenceInput[] = [
  ...
  moduleEvidence('finance', 'Fee Management', 'apps/web/src/components/dashboard/finance-widget.tsx', ['finance'], 'apps/web/src/app/api/payments/[...path]/route.ts', ['proxyPaymentsRequest', 'paymentsPath'], 'apps/api/src/modules/billing/billing.controller.ts', ['BillingController'], 'apps/api/src/modules/billing/billing-schema.service.ts', ['fee_structures'], 'apps/api/src/modules/billing/billing.test.ts', ['billing']),
...
export function writeImplementation100CertificationArtifact(
  ...
  writeFileSync(outputPath, renderImplementation100CertificationMarkdown(result), 'utf8');
}
