...
export const SCHOOL_STAFF_ROLE_CODES = [
  DEFAULT_ROLE_OWNER,
  DEFAULT_ROLE_ADMIN,
  DEFAULT_ROLE_STAFF,
  DEFAULT_ROLE_PRINCIPAL,
  DEFAULT_ROLE_DEPUTY_PRINCIPAL,
  DEFAULT_ROLE_SECRETARY,
  DEFAULT_ROLE_BURSAR,
  ...
  DEFAULT_ROLE_NURSE,
  DEFAULT_ROLE_CLINIC_STAFF,
  DEFAULT_ROLE_COUNSELLOR,
  DEFAULT_ROLE_DISCIPLINE_MASTER,
  DEFAULT_ROLE_LIBRARIAN,
  DEFAULT_ROLE_STOREKEEPER,
  DEFAULT_ROLE_BOARDING_MASTER,
  DEFAULT_ROLE_SECURITY_OFFICER,
  DEFAULT_ROLE_TRANSPORT_MANAGER,
...
export const DEFAULT_PERMISSION_CATALOG = [
  ...
  { resource: 'finance', action: 'follow-up', description: 'View student fee arrears and coordinate school fee follow-up' },
  ...
  { resource: 'academics', action: 'manage-lifecycle', description: 'Archive, restore, close, or delete unused academic setup records' },
  { resource: 'academics', action: 'merge', description: 'Run controlled academic setup merge migrations' },
  { resource: 'teacher', action: 'read', description: 'View the authenticated teacher command workspace and assigned teaching records' },
  { resource: 'teacher', action: 'write', description: 'Manage the authenticated teacher workflows within assigned teaching scopes' },
  ...
  { resource: 'labs', action: 'request', description: 'Submit school practical lesson requisitions without managing laboratory stock' },
