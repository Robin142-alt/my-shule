...
export class TransportController {
  ...
  @Post('assignments')
  @Permissions('transport:write')
  createAssignment(@Body() dto: CreateTransportAssignmentDto) {
    return this.transportService.createAssignment(dto);
  }

  @Get('vehicles')
  @Permissions('transport:read')
  getVehicles() {
    return this.transportService.listVehicles();
  }

  @Get('trips')
  @Permissions('transport:read')
  getTrips() {
    return this.transportService.listTrips();
  }
}
