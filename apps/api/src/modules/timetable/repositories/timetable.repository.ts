    ...
    const result = await this.executeSql(
      `
        SELECT
          ...
          COALESCE(NULLIF(original_teacher.display_name, ''), NULLIF(original_teacher.staff_number, ''), slot.teacher_id) AS original_teacher_name,
          ...
          COALESCE(NULLIF(substitute.display_name, ''), NULLIF(substitute.staff_number, ''),
                   NULLIF(original_teacher.display_name, ''), NULLIF(original_teacher.staff_number, ''), slot.teacher_id) AS effective_teacher_name,
