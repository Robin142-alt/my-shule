...
const schoolNavMap: Record<SchoolExperienceRole | PortalViewer, ExperienceNavItem[]> = {
  ...
  "deputy-principal": [
    ...
    { id: "attendance", label: "Attendance & Punctuality", href: "/attendance", icon: LayoutGrid },
    { id: "staff-duty", label: "Staff Duty", href: "/staff-duty", icon: LayoutGrid },
    { id: "timetable", label: "Timetable & Relief", href: toSchoolPath("timetable"), icon: CalendarDays },
    { id: "discipline", label: "Discipline & Behaviour", href: toSchoolPath("discipline"), icon: LayoutGrid },
    { id: "welfare", label: "Student Welfare", href: "/welfare", icon: LayoutGrid },
    { id: "academics", label: "Academic Foundation", href: toSchoolPath("academics"), icon: GraduationCap },
    { id: "classes", label: "Classes & Streams", href: toSchoolPath("classes"), icon: Building2 },
    { id: "teaching", label: "Teaching Workspace", href: "/teaching", icon: BookOpenCheck },
    { id: "exams", label: "Exams & Marks", href: toSchoolPath("exams"), icon: GraduationCap },
    { id: "academic-intelligence", label: "Academic Intelligence", href: toSchoolPath("academic-intelligence"), icon: Activity },
    { id: "approvals", label: "Approvals", href: toSchoolPath("approvals"), icon: ClipboardList },
  ...
  "class-teacher": [
    ...
    { id: "timetable", label: "Class Timetable", href: toSchoolPath("timetable"), icon: CalendarDays },
