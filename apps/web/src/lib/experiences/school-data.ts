...
const schoolNavMap: Record<SchoolExperienceRole, ExperienceNavItem[]> = {
  principal: [
    ...
    { id: "leadership", label: "Leadership", href: toSchoolPath("leadership"), icon: Building2, group: "Operations" },
    ...
    { id: "ai-insights", label: "AI Insights", href: toSchoolPath("ai-insights"), icon: ShieldAlert, group: "Operations" },
