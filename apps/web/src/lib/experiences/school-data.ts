...
const schoolNavMap: Record<SchoolExperienceRole | PortalViewer, ExperienceNavItem[]> = {
  ...
  "admissions": [
    ...
    { id: "admissions", label: "Admissions", href: toSchoolPath("admissions"), icon: Users },
  ...
  "laboratory-technician": [
    { id: "overview", label: "Overview", href: toSchoolPath("overview"), icon: LayoutGrid },
    { id: "lab-inventory", label: "Lab Inventory", href: toSchoolPath("lab-inventory"), icon: Boxes },
    { id: "apparatus-issue", label: "Apparatus Issue", href: toSchoolPath("apparatus-issue"), icon: ClipboardList },
