...
export const GLOBAL_OPERATING_SYSTEM_CONTRACT = {
  ...
  buttonCategories: {
    ...
    communication: {
      examples: ["Send SMS", "Call Parent", "Send Email", "Send Notice", "Resend Message", "Notify Staff"],
      requirements: ["recipient validation", "template", "delivery tracking", "retry queue"],
    },
  },
  formSystem: {
    footer: ["Cancel", "Save Draft", "Submit", "Preview", "Print", "Submit for Approval", "Save and Send SMS", "Save and Print"],
    inputs: [
      "text input",
      "number input",
      "currency input",
...
const implementation1370UniversalRoleEnrichment: RolePracticalityEnrichment = {
  ...
  primaryActions: ["Search", "Print", "Send SMS", "Submit Approval", "View Action History", "Retry Sync"],
  ...
  tableRowActions: ["Search", "Print", "Send SMS", "View Action History", "Retry"],
  ...
  formFooterActions: ["Print", "Submit for Approval", "Save and Send SMS", "Retry Sync"],
  queueActions: ["Search", "Print", "Send SMS", "Approve", "View Action History", "Retry Sync"],
};
...
function roleQueue(
  ...
  return {
    ...
    priority,
    workflow,
    actions: [...new Set([...actions, "View Action History"])],
    auditEvent,
...
const roleBlueprints: OperationalRoleBlueprint[] = [
  ...
  roleBlueprint({
    ...
    forms: [form("Student Record Form", ["Admission number", "First name", "Surname", "Gender", "Date of birth", "Class", "Stream", "Parent phone"], ["Save Student", "Save and Print Profile"])],
  ...
  roleBlueprint({
    ...
    forms: [form("Payment Form", ["Student selector", "Amount paid", "Payment method", "Transaction code", "Term", "Year", "Vote head", "Notes"], ["Save Payment", "Save and Print Receipt", "Save and SMS Parent"])],
  ...
  roleBlueprint({
    ...
    primaryActions: ["Record Incident", "Call Student", "Notify Parent", "Refer to Counsellor", "Generate Warning Letter"],
  ...
  roleBlueprint({
    ...
    primaryActions: ["Create School", "Enable Module", "Set Billing Status", "Suspend School", "View Action History"],
    ...
    printOutputs: ["School report", "Module assignment report", "Action history export"],
  ...
  roleBlueprint({
    ...
    tables: [table("Failure Queue", ["Service", "School Update", "School", "Attempts", "Status", "Action"], ["Retry", "Replay Update", "Mark Issue Solved", "View Action History"], ["Retry selected", "Export"])],
    ...
    printOutputs: ["System health report", "Failure report", "Action history export"],
...
const addedModuleContracts: DocxAddedModuleContract[] = [
  moduleContract({
    ...
    urgentActionStrip: ["Add Student", "Update Parent Phone", "Record Visitor", "Print Admission Letter", "Return Parent Call"],
    ...
    forms: [form("Student Record Form", ["Admission number", "First name", "Surname", "Gender", "County", "Class", "Stream", "Parent phone"], ["Save Student", "Save and Print Profile"])],
  ...
  moduleContract({
    ...
    urgentActionStrip: ["Validate Import", "Fix Errors", "Save and Continue", "Launch School"],
    ...
    forms: [form("School Profile Step", ["School name", "County", "Academic year", "Current term", "Classes", "Streams"], ["Save and Continue"])],
  ...
  moduleContract({
    ...
    forms: [form("Add ICT Asset Form", ["Asset name", "Category", "Serial number", "Asset tag", "Purchase cost", "Warranty expiry"], ["Save and Print Barcode"])],
