...
export default function ParentBoardingPage() {
  ...
  const { data: moduleResult, isLoading } = useSchoolQuery<any>(
    selectedChildId ? "/api/parent/boarding/" + selectedChildId : null
  );
      ...
      >
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="mt-2 text-sm text-[#64748B]">There are no boarding records available yet.</p>
          </div>
        )}
      </Panel>
