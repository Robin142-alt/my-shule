...
function PublicTenantSchoolPage({ slug }: { slug: string }) {
  ...
  const description = `${schoolName} can use MyShule to connect parent communication, school reporting, and operational visibility through a structured school workspace.`;
  ...
  return (
    <PublicSiteShell>
      ...
      <HeroSection
        ...
        secondaryDescription="This public school route is ready for verified tenant pages while role-based school dashboards continue to use protected access."
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-4 px-5 py-12 sm:px-8 md:grid-cols-3 lg:px-10">
        ...
        <InfoCard title="School control" description="Staff access remains role-aware and tenant isolated." tone="blue" />
