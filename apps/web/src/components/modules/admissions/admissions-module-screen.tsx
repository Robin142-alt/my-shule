    ...
    try {
      ...
      if (liveSession.session) {
        ...
        const profile: AdmissionsStudentProfile = {
          ...
          emergencyContact: application.emergencyContact || "Not recorded",
          academics: [],
          discipline: [],
          fees: [],
          documents: [
    ...
    try {
      ...
      if (liveSession.session) {
        ...
        const profile: AdmissionsStudentProfile = {
          ...
          kcpeResults: registrationForm.kcpeResults.trim() || "Not recorded",
          cbcLevel: registrationForm.cbcLevel.trim() || "Not recorded",
          nemisUpi: registrationForm.nemisUpi.trim() || "Not provided",
          registrationDate: todayIsoDate(),
          applicationStatus: "registered",
          feesBalance: 0,
          lastPayment: "No payment posted yet",
          ...
          emergencyContact: registrationForm.emergencyContact.trim() || "Not recorded",
          academics: [],
          discipline: [],
          fees: [],
