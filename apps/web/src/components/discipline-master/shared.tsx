...
export function EmptyState({ message, icon: Icon, action }: { message: string, icon: LucideIcon, action?: ReactNode }) {
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      <Icon className="h-12 w-12 text-[#64748B]/30 mb-4" />
      <p className="text-lg font-semibold text-[#071D49]">{message}</p>
