...
const MOCK_REFERRALS = [
  { id: "REF-001", student: "Sarah Njoroge", reason: "Repeated Substance Abuse", referredOn: "2026-06-11", status: "Pending Acceptance" },
];
              ...
              <tbody className="divide-y divide-[#D8E0EC]">
                {MOCK_REFERRALS.map((row) => (
                  <tr key={row.id} className="hover:bg-[#F8FAFC]">
                    ...
                    <td className="px-4 py-3">{row.referredOn}</td>
