...
export function ReportsWorkspace() {
  const { data, isLoading } = useSchoolQuery<ReportsData>('/admin-command/laboratory-technician/reports');
  ...
  return (
    <Panel title="Lab Reports" description="Generate and download laboratory reports." icon={FileText}>
