// GENERATED BY scaffold_nurse_query.js
"use client";
...
type ViewId = "overview" | "queue" | "new-visit" | "records" | "profiles" | "inventory" | "dispense" | "stock-requests" | "emergencies" | "referrals" | "incidents" | "notifications" | "boarding-health" | "reports" | "settings";
...
const navItems: NavItem[] = [
  { id: "overview", label: "Overview", icon: LayoutDashboard, group: "Nurse Station" },
  { id: "queue", label: "Sick Bay Queue", icon: List, group: "Visits" },
  { id: "new-visit", label: "New Visit", icon: PlusCircle, group: "Visits" },
  { id: "records", label: "Visit Records", icon: ClipboardCheck, group: "Visits" },
  { id: "profiles", label: "Health Profiles", icon: Users, group: "Student Health" },
  { id: "inventory", label: "Medicine Inventory", icon: Boxes, group: "Stock & Pharmacy" },
  { id: "dispense", label: "Dispense Medicine", icon: Pill, group: "Stock & Pharmacy" },
  { id: "stock-requests", label: "Stock Requests", icon: ShoppingCart, group: "Stock & Pharmacy" },
  { id: "emergencies", label: "Emergency Cases", icon: AlertTriangle, group: "Urgent" },
  { id: "referrals", label: "Referrals & Follow-ups", icon: Ambulance, group: "Urgent" },
  { id: "incidents", label: "Health Incidents", icon: Activity, group: "Urgent" },
  { id: "notifications", label: "Parent Notifications", icon: MessageSquare, group: "Communication" },
  { id: "boarding-health", label: "Boarding Health", icon: Building, group: "Communication" },
  { id: "reports", label: "Reports", icon: FileText, group: "Management" },
  { id: "settings", label: "Health Settings", icon: Settings, group: "Management" },
];
          ...
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-[#64748B]">School Nurse Ã¢â‚¬Â¢ Term 2, 2026</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
