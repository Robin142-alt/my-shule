...
export function NotificationsWorkspace() {
  const { data, isLoading } = useSchoolQuery<NotificationsData>("/admin-command/parent/notifications");
    ...
    <section className="rounded-2xl border border-[#D8E0EC] bg-white p-5 shadow-[0_18px_50px_rgba(7,29,73,0.08)]">
      <div className="mb-4 flex min-w-0 gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm leading-6 text-[#64748B]">View school notifications and alerts.</p>
        </div>
      </div>
