  ...
  return <div className="min-h-screen bg-slate-50 text-slate-900 lg:grid lg:grid-cols-[240px_minmax(0,1fr)]" data-testid="hos-command-center">
    ...
    <main className="min-w-0 space-y-5 p-4 sm:p-6">
      ...
      {appointmentsView ? <SubjectAppointmentsWorkspace /> : <>
        <p className="text-sm text-slate-600">Review subject results, find learners who need support, and prepare reports. Missing access? <Link href={buildSchoolSectionHref("hos", "subjects", routeMode)} className="font-semibold text-blue-700 underline">Check your subject appointments</Link>.</p>
