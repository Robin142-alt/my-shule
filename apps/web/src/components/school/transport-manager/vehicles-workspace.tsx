...
export function VehiclesWorkspace() {
  const { data, error, isLoading, refetch } = useSchoolQuery<VehiclesData>('/admin-command/transport-manager/vehicles');
  ...
  if (error) {
    return (
      <Panel title="Vehicles" description="Manage the school transport fleet." icon={Car}>
        <div role="alert" className="rounded-xl border border-rose-200 bg-rose-50 p-4 text-sm text-rose-800">
          <p className="font-black">Vehicles could not be loaded.</p>
