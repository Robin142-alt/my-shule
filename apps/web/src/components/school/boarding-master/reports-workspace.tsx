...
export function ReportsWorkspace() {
  const { data, isLoading } = useSchoolQuery<ReportsData>('/admin-command/boarding-master/reports');
  ...
  return (
    <Panel title="Boarding Reports" description="Generate and download boarding reports." icon={FileText}>
