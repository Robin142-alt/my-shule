...
export function ReportsWorkspace() {
  const { data, isLoading } = useSchoolQuery<ReportsData>('/admin-command/exams-manager/reports');
  ...
  return (
    <Panel title="Exam Reports" description="Generate and download exam administration reports." icon={FileText}>
