...
export function TemplatesWorkspace() {
  const { data, isLoading } = useSchoolQuery<TemplatesData>("/admin-command/admissions/templates");
  ...
  return (
    <section className="rounded-2xl border border-[#D8E0EC] bg-white p-5 shadow-[0_18px_50px_rgba(7,29,73,0.08)]">
      <div className="mb-4 flex min-w-0 gap-3">
        ...
        <div>
          <h2 className="text-xl font-black tracking-[-0.01em] text-[#071D49]">Templates</h2>
          <p className="mt-1 text-sm leading-6 text-[#64748B]">Manage admission letter and form templates.</p>
        </div>
      </div>

      <div className="grid gap-4 md:grid-cols-2 mb-6">
        <div className="rounded-xl border border-[#D8E0EC] bg-[#F8FAFC] p-4">
          <div className="text-sm font-semibold text-[#64748B]">Total Templates</div>
