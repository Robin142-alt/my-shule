...
export function AdmissionsOverviewWorkspace({ dataset }: { dataset?: any }) {
  return (
      ...
      <Card className="border border-white/10 bg-white/5 p-6">
        ...
        <div className="mt-4">
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-lg font-semibold text-white">High-level metrics and admission summary.</p>
