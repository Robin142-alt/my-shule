...
export function ReportIntakeWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/report-intake");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Report Intake" 
          description="Manage Report Intake records and workflows." 
        />
        <DisciplineWorkspaceActions title="Report Intake" records={records} />
      </div>
