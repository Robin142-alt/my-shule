...
export function ParentSummonsWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/parent-summons");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Parent Summons" 
          description="Manage Parent Summons records and workflows." 
        />
        <DisciplineWorkspaceActions title="Parent Summons" records={records} />
      </div>
