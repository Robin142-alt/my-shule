...
export function ReportsWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/reports");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Reports" 
          description="Manage Reports records and workflows." 
        />
        <DisciplineWorkspaceActions title="Reports" records={records} />
      </div>
