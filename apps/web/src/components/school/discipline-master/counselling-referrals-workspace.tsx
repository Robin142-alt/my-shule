...
export function CounsellingReferralsWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/counselling-referrals");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          description="Manage Counselling Referrals records and workflows." 
        />
        <DisciplineWorkspaceActions title="Counselling Referrals" records={records} />
      </div>
      ...
      <DataTable 
        title="Recent Counselling Referrals" 
