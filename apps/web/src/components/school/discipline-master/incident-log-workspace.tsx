...
export function IncidentLogWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/incident-log");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Incident Log" 
          description="Manage Incident Log records and workflows." 
        />
        <DisciplineWorkspaceActions title="Incident Log" records={records} />
      </div>
