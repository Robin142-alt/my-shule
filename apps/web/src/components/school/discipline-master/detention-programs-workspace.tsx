...
export function DetentionProgramsWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/detention-programs");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          description="Manage Detention Programs records and workflows." 
        />
        <DisciplineWorkspaceActions title="Detention Programs" records={records} />
      </div>
      ...
      <DataTable 
        title="Recent Detention Programs" 
