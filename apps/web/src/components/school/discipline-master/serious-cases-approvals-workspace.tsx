...
export function SeriousCasesApprovalsWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/serious-cases-approvals");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Serious Cases Approvals" 
          description="Manage Serious Cases Approvals records and workflows." 
        />
        <DisciplineWorkspaceActions title="Serious Cases Approvals" records={records} />
      </div>
      ...
      <DataTable 
        title="Recent Serious Cases Approvals" 
