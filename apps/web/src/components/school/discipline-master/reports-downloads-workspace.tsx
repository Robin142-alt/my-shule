...
export function ReportsDownloadsWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/reports-downloads");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          description="Manage Reports Downloads records and workflows." 
        />
        <DisciplineWorkspaceActions title="Reports Downloads" records={records} />
      </div>
      ...
      <DataTable 
        title="Recent Reports Downloads" 
