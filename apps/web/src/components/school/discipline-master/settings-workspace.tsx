...
export function SettingsWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/settings");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Settings" 
          description="Manage Settings records and workflows." 
        />
        <DisciplineWorkspaceActions title="Settings" records={records} />
      </div>
