...
export function StudentConductProfilesWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/student-conduct-profiles");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Student Conduct Profiles" 
          description="Manage Student Conduct Profiles records and workflows." 
        />
        <DisciplineWorkspaceActions title="Student Conduct Profiles" records={records} />
      </div>
      ...
      <DataTable 
        title="Recent Student Conduct Profiles" 
