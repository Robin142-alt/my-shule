...
export function IncidentRegisterWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/incident-register");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          description="Manage Incident Register records and workflows." 
        />
        <DisciplineWorkspaceActions title="Incident Register" records={records} />
      </div>
      ...
      <DataTable 
        title="Recent Incident Register" 
