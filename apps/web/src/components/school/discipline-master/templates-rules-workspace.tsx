...
export function TemplatesRulesWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/templates-rules");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          description="Manage Templates Rules records and workflows." 
        />
        <DisciplineWorkspaceActions title="Templates Rules" records={records} />
      </div>
