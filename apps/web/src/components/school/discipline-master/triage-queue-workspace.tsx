...
export function TriageQueueWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/triage-queue");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Triage Queue" 
          description="Manage Triage Queue records and workflows." 
        />
        <DisciplineWorkspaceActions title="Triage Queue" records={records} />
      </div>
