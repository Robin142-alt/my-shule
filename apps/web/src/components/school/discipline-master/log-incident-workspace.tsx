...
export function LogIncidentWorkspace() {
  const { data, isLoading } = useSchoolQuery<any[]>("/discipline/log-incident");
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <PageHeader 
          ...
          title="Log Incident" 
          description="Manage Log Incident records and workflows." 
        />
        <DisciplineWorkspaceActions title="Log Incident" records={records} />
      </div>
