  ...
  return (
    <Panel title="School Setup Checklist" description="Track school setup completion for the current term." icon={CheckSquare}>
      <div className="grid gap-4 md:grid-cols-3 mb-6">
        ...
        <div className="rounded-xl border border-[#D8E0EC] bg-[#F8FAFC] p-4">
          <div className="text-sm font-semibold text-[#64748B]">Not Started</div>
          <div className="mt-1 text-lg font-black text-[#071D49]">{isLoading ? "..." : data?.metrics?.not_started ?? 0}</div>
        </div>
      </div>
