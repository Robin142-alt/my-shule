...
export function ReportsWorkspace() {
  const { data, isLoading } = useSchoolQuery<ReportsData>('/admin-command/principal/reports');
  ...
  return (
    <Panel title="Principal Reports" description="Generate and download school-wide reports." icon={FileText}>
