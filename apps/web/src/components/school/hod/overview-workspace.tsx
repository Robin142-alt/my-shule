        ...
        <RecordTable className="w-full text-sm text-left whitespace-nowrap">
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr><td colSpan={2} className="px-4 py-8 text-center text-[#64748B]">No department alerts yet. Coverage gaps, resource requests, and marks moderation items will appear here.</td></tr>
            ) : (
              items.map(row => (
