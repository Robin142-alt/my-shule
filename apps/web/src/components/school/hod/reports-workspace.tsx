...
export function ReportsWorkspace() {
  const { data, isLoading } = useSchoolQuery<ReportsData>('/admin-command/hod/reports');
  ...
  return (
    <Panel title="Department Reports" description="Generate and download department reports." icon={FileText}>
