      ...
      {!isLoading && activeTab === "allocations" ? (
        <div role="tabpanel" className="space-y-5">
          ...
          <div className="grid gap-5 xl:grid-cols-2">
            ...
            <SetupForm title="Assign subject teacher" description="The teacher continues across terms and follows the class as students are promoted, until reassigned or ended. Set an end date only for a temporary allocation.">
