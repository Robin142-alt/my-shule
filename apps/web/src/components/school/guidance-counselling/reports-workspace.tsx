...
export function ReportsWorkspace() {
  const { data, isLoading } = useSchoolQuery<ReportsData>('/admin-command/guidance-counselling/reports');
  ...
  return (
    <Panel title="Counselling Reports" description="Generate and download counselling reports." icon={FileText}>
