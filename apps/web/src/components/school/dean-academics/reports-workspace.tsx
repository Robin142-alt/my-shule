...
export function ReportsWorkspace() {
  const { data, isLoading } = useSchoolQuery<ReportsData>('/admin-command/dean-academics/reports');
  ...
  return (
    <Panel title="Academic Reports" description="Generate and download academic reports." icon={FileText}>
